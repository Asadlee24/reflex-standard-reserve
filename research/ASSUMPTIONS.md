...
| **`ASM-012`** | **Auction price schedule** | `REFLEX ASSUMPTION` | Explicit non-increasing time/price points | Whitepaper v0.1 §§7–8 specifies Dutch purchases; discrete sampling is a fixture abstraction | Not a Genesis forecast or canonical exponential implementation | `AuctionSpec` | Verified implementation and launch configuration |
