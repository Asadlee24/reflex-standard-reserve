...
| **`SR-SUPPLY-002`** | SUPPLY | Hard cap 1B; genesis 100M STANDARD as locked protocol-owned liquidity. | PUBLISHED_DESIGN | [Whitepaper v0.1](https://www.standardreserve.xyz/whitepaper/) | §3 The currency | These are browser defaults; unit fixtures can use custom sizes. |
...
| **`SR-CHARTER-002`** | CHARTERS | Last branch retirement burns the Charter. Re-entry requires a new Charter. | PUBLISHED_DESIGN | [Whitepaper v0.1](https://www.standardreserve.xyz/whitepaper/) | §§6 and 9 | Terminal burn is modeled; no Dormant reactivation. |
...
| **`SR-AUCTION-001`** | AUCTIONS | Daily Dutch sales execute at the current falling price; licence payments burn STANDARD. | PUBLISHED_DESIGN | [Whitepaper v0.1](https://www.standardreserve.xyz/whitepaper/) | §§7–8 | Explicit discrete schedule abstracts the curve. Not Genesis configuration. |
| **`SR-AUCTION-002`** | AUCTIONS | Successful purchases consume one unit. Failed or sold-out purchases cannot consume supply. | DERIVED | [Whitepaper v0.1](https://www.standardreserve.xyz/whitepaper/) | §8 | Current-price receipts do not get final-clearing rebates in this daily-auction model. |
